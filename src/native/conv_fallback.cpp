    ...
    static void fwd_tile(
        ...
        for (int64_t cin = 0; cin < C_in; ++cin) {
            ...
            for (int64_t kh = 0; kh < K; ++kh) {
                ...
                __m256 vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8;
                stride1_kw_windows_alignr9(in_row, iw0, vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8);
                ...
                vo0 = _mm256_fmadd_ps(vx5, _mm256_set1_ps(w0[5]), vo0);
                vo0 = _mm256_fmadd_ps(vx6, _mm256_set1_ps(w0[6]), vo0);
                vo0 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w0[7]), vo0);
                vo0 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w0[8]), vo0);
                ...
                vo1 = _mm256_fmadd_ps(vx5, _mm256_set1_ps(w1[5]), vo1);
                vo1 = _mm256_fmadd_ps(vx6, _mm256_set1_ps(w1[6]), vo1);
                vo1 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w1[7]), vo1);
                vo1 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w1[8]), vo1);
                }
                if (c_rem > 2) {
                    const float* __restrict w2 = wp2 + kh * K;
                vo2 = _mm256_fmadd_ps(vx0, _mm256_set1_ps(w2[0]), vo2);
                ...
                vo2 = _mm256_fmadd_ps(vx5, _mm256_set1_ps(w2[5]), vo2);
                vo2 = _mm256_fmadd_ps(vx6, _mm256_set1_ps(w2[6]), vo2);
                vo2 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w2[7]), vo2);
                vo2 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w2[8]), vo2);
                }
                if (c_rem > 3) {
                    const float* __restrict w3 = wp3 + kh * K;
                vo3 = _mm256_fmadd_ps(vx0, _mm256_set1_ps(w3[0]), vo3);
                ...
                vo3 = _mm256_fmadd_ps(vx5, _mm256_set1_ps(w3[5]), vo3);
                vo3 = _mm256_fmadd_ps(vx6, _mm256_set1_ps(w3[6]), vo3);
                vo3 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w3[7]), vo3);
                vo3 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w3[8]), vo3);
                }
            }
        }
    ...
    static void fwd_tile(
        ...
        for (int64_t cin = 0; cin < C_in; ++cin) {
            ...
            for (int64_t kh = 0; kh < K; ++kh) {
                ...
                __m256 vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8, vx9, vx10;
                stride1_kw_windows_alignr11(
                    in_row, iw0, vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8, vx9, vx10
                );
                ...
                vo0 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w0[7]), vo0);
                vo0 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w0[8]), vo0);
                vo0 = _mm256_fmadd_ps(vx9, _mm256_set1_ps(w0[9]), vo0);
                vo0 = _mm256_fmadd_ps(vx10, _mm256_set1_ps(w0[10]), vo0);
                ...
                vo1 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w1[7]), vo1);
                vo1 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w1[8]), vo1);
                vo1 = _mm256_fmadd_ps(vx9, _mm256_set1_ps(w1[9]), vo1);
                vo1 = _mm256_fmadd_ps(vx10, _mm256_set1_ps(w1[10]), vo1);
                }
                if (c_rem > 2) {
                    const float* __restrict w2 = wp2 + kh * K;
                vo2 = _mm256_fmadd_ps(vx0, _mm256_set1_ps(w2[0]), vo2);
                ...
                vo2 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w2[7]), vo2);
                vo2 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w2[8]), vo2);
                vo2 = _mm256_fmadd_ps(vx9, _mm256_set1_ps(w2[9]), vo2);
                vo2 = _mm256_fmadd_ps(vx10, _mm256_set1_ps(w2[10]), vo2);
                }
                if (c_rem > 3) {
                    const float* __restrict w3 = wp3 + kh * K;
                vo3 = _mm256_fmadd_ps(vx0, _mm256_set1_ps(w3[0]), vo3);
                ...
                vo3 = _mm256_fmadd_ps(vx7, _mm256_set1_ps(w3[7]), vo3);
                vo3 = _mm256_fmadd_ps(vx8, _mm256_set1_ps(w3[8]), vo3);
                vo3 = _mm256_fmadd_ps(vx9, _mm256_set1_ps(w3[9]), vo3);
                vo3 = _mm256_fmadd_ps(vx10, _mm256_set1_ps(w3[10]), vo3);
                }
            }
        }
...
// --- Stride1Specialist<9> backward implementations ---

static __forceinline void stride1_bwd_dx_accum_cout4_k9(
    __m256& v_dx,
    int64_t ow0,
    const float* __restrict dy0,
    const float* __restrict dy1,
    ...
    v_dx = fmadd_dx_cout4(
        v_dx,
        _mm256_loadu_ps(dy0 + ow0 - 7), _mm256_loadu_ps(dy1 + ow0 - 7),
        _mm256_loadu_ps(dy2 + ow0 - 7), _mm256_loadu_ps(dy3 + ow0 - 7),
        wp0[7], wp1[7], wp2[7], wp3[7]
    );
    v_dx = fmadd_dx_cout4(
        v_dx,
        _mm256_loadu_ps(dy0 + ow0 - 8), _mm256_loadu_ps(dy1 + ow0 - 8),
        _mm256_loadu_ps(dy2 + ow0 - 8), _mm256_loadu_ps(dy3 + ow0 - 8),
        wp0[8], wp1[8], wp2[8], wp3[8]
    );
}

static void stride1_bwd_dx_tile_c8_k9(
    const ConvBwdDxTileDoc& doc,
    const float* __restrict dy_pad_buf,
    int64_t dy_pad_l, int64_t dy_row_stride,
    const float* __restrict W,
    ...
    static constexpr int K = Stride1Specialist<9>::K;
    (void)C_in;
    if (bwd_dx_mock_edges_enabled() &&
        !bwd_dx_tile_is_interior(doc, K, pad, conv_out_w)) {
        return;
...
static void stride1_bwd_dx_tile_c16_k9(
    const ConvBwdDxTileDoc& doc,
    const float* __restrict dy_pad_buf,
    int64_t dy_pad_l, int64_t dy_row_stride,
    const float* __restrict W,
...
void Stride1Specialist<9>::bwd_dx_tile(
    const ConvBwdDxTileDoc& doc,
    const float* __restrict dy_pad_buf,
    int64_t dy_pad_l, int64_t dy_row_stride,
    const float* __restrict W,
    ...
    for (int64_t kh = kh_lo; kh < kh_hi; ++kh) {
        ...
        for (; cout < C_out; ++cout) {
            ...
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 5), wp[5]);
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 6), wp[6]);
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 7), wp[7]);
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 8), wp[8]);
        }
    }
    bwd_dx_store_tile(dx_row, v_dx, full_dx, dx_mask);
}

void Stride1Specialist<9>::dw_nci(
    int64_t n, int64_t cout, int64_t cin,
    float* __restrict dw_slice,
    const float* __restrict dy_pad_buf,
    const float* __restrict x_pad_buf,
    ...
    for (int64_t kh = 0; kh < K; ++kh) {
        ...
        for (int64_t oh = 0; oh < conv_out_h; ++oh) {
            ...
            for (int64_t t = 0; t < ow_tiles; ++t) {
                ...
                __m256 vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8;
                stride1_kw_windows_alignr9(x_row, iw0, vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8);
                ...
                v_acc5 = _mm256_fmadd_ps(dy8, vx5, v_acc5);
                v_acc6 = _mm256_fmadd_ps(dy8, vx6, v_acc6);
                v_acc7 = _mm256_fmadd_ps(dy8, vx7, v_acc7);
                v_acc8 = _mm256_fmadd_ps(dy8, vx8, v_acc8);
            }
        }
        const int64_t base = kh * K;
        dw_slice[base + 0] += _mm256_reduce_add_ps(v_acc0);
        ...
        dw_slice[base + 5] += _mm256_reduce_add_ps(v_acc5);
        dw_slice[base + 6] += _mm256_reduce_add_ps(v_acc6);
        dw_slice[base + 7] += _mm256_reduce_add_ps(v_acc7);
        dw_slice[base + 8] += _mm256_reduce_add_ps(v_acc8);
    }
}

// --- Stride1Specialist<11> backward implementations ---

static __forceinline void stride1_bwd_dx_accum_cout4_k11(
    __m256& v_dx,
    int64_t ow0,
    const float* __restrict dy0,
    const float* __restrict dy1,
    ...
    v_dx = fmadd_dx_cout4(
        v_dx,
        _mm256_loadu_ps(dy0 + ow0 - 9), _mm256_loadu_ps(dy1 + ow0 - 9),
        _mm256_loadu_ps(dy2 + ow0 - 9), _mm256_loadu_ps(dy3 + ow0 - 9),
        wp0[9], wp1[9], wp2[9], wp3[9]
    );
    v_dx = fmadd_dx_cout4(
        v_dx,
        _mm256_loadu_ps(dy0 + ow0 - 10), _mm256_loadu_ps(dy1 + ow0 - 10),
        _mm256_loadu_ps(dy2 + ow0 - 10), _mm256_loadu_ps(dy3 + ow0 - 10),
        wp0[10], wp1[10], wp2[10], wp3[10]
    );
}

static void stride1_bwd_dx_tile_c8_k11(
    const ConvBwdDxTileDoc& doc,
    const float* __restrict dy_pad_buf,
    int64_t dy_pad_l, int64_t dy_row_stride,
    const float* __restrict W,
    ...
    static constexpr int K = Stride1Specialist<11>::K;
    (void)C_in;
    if (bwd_dx_mock_edges_enabled() &&
        !bwd_dx_tile_is_interior(doc, K, pad, conv_out_w)) {
        return;
    ...
    for (int64_t kh = kh_lo; kh < kh_hi; ++kh) {
        ...
        const float* __restrict dy_oh = dy_n + oh * dy_row_stride;
        const float* __restrict w_kh = w_cin + kh * K;
        stride1_bwd_dx_accum_cout4_k11(
            v_dx, ow0,
            dy_oh + 0 * dy_plane, dy_oh + 1 * dy_plane,
            dy_oh + 2 * dy_plane, dy_oh + 3 * dy_plane,
            w_kh + 0 * w_cout_stride, w_kh + 1 * w_cout_stride,
...
static void stride1_bwd_dx_tile_c16_k11(
    const ConvBwdDxTileDoc& doc,
    const float* __restrict dy_pad_buf,
    int64_t dy_pad_l, int64_t dy_row_stride,
    const float* __restrict W,
...
void Stride1Specialist<11>::bwd_dx_tile(
    const ConvBwdDxTileDoc& doc,
    const float* __restrict dy_pad_buf,
    int64_t dy_pad_l, int64_t dy_row_stride,
    const float* __restrict W,
    ...
    for (int64_t kh = kh_lo; kh < kh_hi; ++kh) {
        ...
        for (; cout < C_out; ++cout) {
            ...
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 7), wp[7]);
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 8), wp[8]);
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 9), wp[9]);
            v_dx = fmadd_dx_cout1(v_dx, _mm256_loadu_ps(dy_row + ow0 - 10), wp[10]);
        }
    }
    bwd_dx_store_tile(dx_row, v_dx, full_dx, dx_mask);
}

void Stride1Specialist<11>::dw_nci(
    int64_t n, int64_t cout, int64_t cin,
    float* __restrict dw_slice,
    const float* __restrict dy_pad_buf,
    const float* __restrict x_pad_buf,
    ...
    for (int64_t kh = 0; kh < K; ++kh) {
        ...
        for (int64_t oh = 0; oh < conv_out_h; ++oh) {
            ...
            for (int64_t t = 0; t < ow_tiles; ++t) {
                ...
                __m256 vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8, vx9, vx10;
                stride1_kw_windows_alignr11(
                    x_row, iw0, vx0, vx1, vx2, vx3, vx4, vx5, vx6, vx7, vx8, vx9, vx10
                );
                ...
                v_acc7 = _mm256_fmadd_ps(dy8, vx7, v_acc7);
                v_acc8 = _mm256_fmadd_ps(dy8, vx8, v_acc8);
                v_acc9 = _mm256_fmadd_ps(dy8, vx9, v_acc9);
                v_acc10 = _mm256_fmadd_ps(dy8, vx10, v_acc10);
            }
        }
        const int64_t base = kh * K;
        dw_slice[base + 0] += _mm256_reduce_add_ps(v_acc0);
        ...
        dw_slice[base + 7] += _mm256_reduce_add_ps(v_acc7);
        dw_slice[base + 8] += _mm256_reduce_add_ps(v_acc8);
        dw_slice[base + 9] += _mm256_reduce_add_ps(v_acc9);
        dw_slice[base + 10] += _mm256_reduce_add_ps(v_acc10);
    }
}
...
// ========================================================================
// FWD OC path inspired by oneDNN layouts (fwd ONLY — do not touch bwd).
// From jit_avx2_conv_kernel_f32:
//   - flat IC (<8 or any): wei Ohwi8o = [nb_oc][kh][kw][ic][8]
//   - IC%8==0: wei OIhw8i8o = [nb_oc][nb_ic][kh][kw][8i][8o]
//   - dst compute buffer nChw8c = [N][nb_oc][oh][ow][8], vector stores
//   - broadcast x, vmovups W, ur_w=3 middle; reorder to NCHW once at end
// Gate: stride-1, Cout%8==0, square K in 1..7.
// ========================================================================

static thread_local float* tls_fwd_oc_dst = nullptr;
static thread_local size_t tls_fwd_oc_dst_cap = 0;
static thread_local float* tls_fwd_oc_src = nullptr;
static thread_local size_t tls_fwd_oc_src_cap = 0;

// Durable Ohwi8o / OIhw8i8o packs (Torch/oneDNN reorder once until W changes).
constexpr int32_t FWD_OC_WEI_SLOTS = 4;
struct FwdOcWeiStage {
...
static FwdOcWeiStage g_fwd_oc_wei[FWD_OC_WEI_SLOTS];

static inline void fwd_oc_pack_ohwi8o(
    const float* __restrict W, float* __restrict wei,
    int64_t nb_oc, int64_t C_in, int64_t K);
static inline void fwd_oc_pack_oihw8i8o(
    const float* __restrict W, float* __restrict wei,
    int64_t nb_oc, int64_t nb_ic, int64_t K);

static float* fwd_oc_wei_alloc(FwdOcWeiStage& slot, size_t need) {
...
static float* fwd_oc_wei_lookup(
    const float* W, int64_t C_out, int64_t C_in, int64_t K, bool use_8i8o
) {
    for (int32_t i = 0; i < FWD_OC_WEI_SLOTS; ++i) {
        const FwdOcWeiStage& s = g_fwd_oc_wei[i];
        if (!s.valid || !s.buf || s.w_src != W) continue;
        if (s.C_out != C_out || s.C_in != C_in || s.K != K || s.use_8i8o != use_8i8o)
            continue;
        return s.buf;
    }
    return nullptr;
...
static float* fwd_oc_wei_get_or_pack(
    const float* W, int64_t C_out, int64_t C_in, int64_t K, bool use_8i8o
) {
    if (float* hit = fwd_oc_wei_lookup(W, C_out, C_in, K, use_8i8o)) return hit;
    int32_t slot_i = -1;
    int32_t free_i = -1;
    for (int32_t i = 0; i < FWD_OC_WEI_SLOTS; ++i) {
        if (g_fwd_oc_wei[i].w_src == W) { slot_i = i; break; }
        if (free_i < 0 && !g_fwd_oc_wei[i].valid) free_i = i;
    }
    if (slot_i < 0) slot_i = (free_i >= 0) ? free_i : 0;
    FwdOcWeiStage& slot = g_fwd_oc_wei[slot_i];
    slot.valid = false;
    const int64_t nb_oc = C_out / 8;
    const int64_t nb_ic = use_8i8o ? (C_in / 8) : 0;
    const size_t need = use_8i8o
        ? (size_t)nb_oc * (size_t)nb_ic * (size_t)K * (size_t)K * 64u
        : (size_t)nb_oc * (size_t)K * (size_t)K * (size_t)C_in * 8u;
    float* buf = fwd_oc_wei_alloc(slot, need);
    if (!buf) return nullptr;
    if (use_8i8o) fwd_oc_pack_oihw8i8o(W, buf, nb_oc, nb_ic, K);
    else fwd_oc_pack_ohwi8o(W, buf, nb_oc, C_in, K);
    slot.w_src = W;
    slot.C_out = C_out;
    slot.C_in = C_in;
    slot.K = K;
    slot.use_8i8o = use_8i8o;
    slot.valid = true;
    return buf;
}

extern "C" ML_ENGINE_EXPORT void invalidate_fwd_oc_wei_pack(void) {
    for (int32_t i = 0; i < FWD_OC_WEI_SLOTS; ++i) {
        g_fwd_oc_wei[i].valid = false;
    }
}

static float* acquire_fwd_oc_buf(float*& ptr, size_t& cap, size_t need) {
    if (need == 0) return nullptr;
    if (need > cap) {
        std::free(ptr);
        const size_t bytes = ((need * sizeof(float)) + 63u) & ~(size_t)63u;
        ptr = (float*)std::aligned_alloc(64, bytes);
        cap = ptr ? (bytes / sizeof(float)) : 0;
    }
    return ptr;
}

// Ohwi8o: [nb_oc][kh][kw][ic][8]
static inline void fwd_oc_pack_ohwi8o(
    const float* __restrict W, float* __restrict wei,
    int64_t nb_oc, int64_t C_in, int64_t K
) {
        ...
        for (int64_t kh = 0; kh < K; ++kh) {
            for (int64_t kw = 0; kw < K; ++kw) {
                for (int64_t ic = 0; ic < C_in; ++ic) {
                    float* __restrict d =
                        &wei[((((oc_b * K + kh) * K + kw) * C_in + ic) * 8)];
                    for (int c = 0; c < 8; ++c) {
                        const int64_t cout = oc_b * 8 + c;
                        d[c] = W[((cout * C_in + ic) * K + kh) * K + kw];
                    }
                }
            }
        }
...
// OIhw8i8o: [nb_oc][nb_ic][kh][kw][8i][8o]
static inline void fwd_oc_pack_oihw8i8o(
    const float* __restrict W, float* __restrict wei,
    int64_t nb_oc, int64_t nb_ic, int64_t K
) {
    ...
    for (int64_t oc_b = 0; oc_b < nb_oc; ++oc_b) {
        for (int64_t ic_b = 0; ic_b < nb_ic; ++ic_b) {
            for (int64_t kh = 0; kh < K; ++kh) {
                for (int64_t kw = 0; kw < K; ++kw) {
                    float* __restrict d =
                        &wei[((((oc_b * nb_ic + ic_b) * K + kh) * K + kw) * 64)];
                    for (int ic = 0; ic < 8; ++ic) {
                        for (int oc = 0; oc < 8; ++oc) {
                            const int64_t cout = oc_b * 8 + oc;
                            const int64_t cin = ic_b * 8 + ic;
                            d[ic * 8 + oc] =
                                W[((cout * (nb_ic * 8) + cin) * K + kh) * K + kw];
                        }
                    }
                }
            }
...
static inline void fwd_oc_reorder_nChw8c_to_nchw(
    const float* __restrict blocked, float* __restrict out,
    int64_t N, int64_t C_out, int64_t out_h, int64_t out_w,
    int64_t out_w_stride, const float* bias, bool fuse_relu
) {
    const int64_t nb_oc = C_out / 8;
    const int64_t spatial_out = out_h * out_w_stride;
    const __m256 v_zero = _mm256_setzero_ps();

    // Halo / unread cols: bias or zero fill once (cheap vs old full-plane bias).
    if (out_w_stride > out_w || bias) {
        #pragma omp parallel for collapse(2) schedule(static)
        for (int64_t n = 0; n < N; ++n) {
            for (int64_t cout = 0; cout < C_out; ++cout) {
                ...
                for (int64_t oh = 0; oh < out_h; ++oh) {
                    float* row = out_ptr + oh * out_w_stride;
                    for (int64_t ow = out_w; ow < out_w_stride; ++ow) row[ow] = bv;
                }
            }
        }
    }
        ...
        for (int64_t oc_b = 0; oc_b < nb_oc; ++oc_b) {
            for (int64_t oh = 0; oh < out_h; ++oh) {
                const float* __restrict src_row =
                    &blocked[((n * nb_oc + oc_b) * out_h + oh) * out_w * 8];
                for (int64_t ow = 0; ow < out_w; ++ow) {
                    __m256 v = _mm256_loadu_ps(src_row + ow * 8);
                    if (fuse_relu) v = _mm256_max_ps(v, v_zero);
                    if (bias) {
                        alignas(32) float bs[8];
                        for (int c = 0; c < 8; ++c) bs[c] = bias[oc_b * 8 + c];
                        v = _mm256_add_ps(v, _mm256_load_ps(bs));
                    }
                    alignas(32) float tmp[8];
                    _mm256_store_ps(tmp, v);
                    const int64_t row = oh * out_w_stride + ow;
                    for (int c = 0; c < 8; ++c) {
                        out[(n * C_out + oc_b * 8 + c) * spatial_out + row] = tmp[c];
                    }
                }
            }
        }
...
// oneDNN jit_avx2_conv fwd for ic%8==0, oc%8==0, stride-1:
//   src nChw8c, wei OIhw8i8o, dst nChw8c, SIMD over OC-8, ur_w=3,
//   nb_oc_blocking up to 2, lpad/mid/rpad/tail OW walk with jj_start/jj_end.
template <int K>
static bool conv2d_forward_oc_mimo_avx2(
    const float* x, const float* W, const float* bias, float* out,
    int64_t N, int64_t C_in, int64_t H, int64_t W_in, int64_t W_in_stride,
    int64_t C_out, int64_t pad, int64_t out_w_stride, int32_t fuse_relu
) {
    const int64_t out_h = (H + 2 * pad - K) + 1;
    const int64_t out_w = (W_in + 2 * pad - K) + 1;
    if (out_h <= 0 || out_w <= 0) return false;
    if ((C_in % 8) != 0 || (C_out % 8) != 0) return false;

    const int64_t nb_oc = C_out / 8;
    const int64_t nb_ic = C_in / 8;
    const int64_t spatial_in = H * W_in_stride;
    const bool trace = fwd_trace_enabled();

    if (trace) {
        std::printf(
            "[FWD_TRACE] === native OC-mimo ENTER === K=%d N=%lld Cin=%lld Cout=%lld "
            "H=%lld Win=%lld Win_stride=%lld pad=%lld out=%lldx%lld out_w_stride=%lld\n",
            K, (long long)N, (long long)C_in, (long long)C_out,
            (long long)H, (long long)W_in, (long long)W_in_stride,
            (long long)pad, (long long)out_h, (long long)out_w,
            (long long)out_w_stride);
        std::printf(
            "[FWD_TRACE] op0 input layout: NCHW dense  "
            "index=(n*Cin+c)*H*Win_stride + ih*Win_stride + iw\n");
        fwd_trace_ptr("x(NCHW)", x, 8);
        fwd_trace_ptr("W(OIHW)", W, 8);
    }

    float* __restrict wei = fwd_oc_wei_get_or_pack(W, C_out, C_in, K, true);
    if (!wei) return false;

    if (trace) {
        std::printf(
            "[FWD_TRACE] op1 wei pack: OIhw8i8o = [nb_oc=%lld][nb_ic=%lld][kh=%d][kw=%d][8i][8o]  "
            "floats=%lld\n",
            (long long)nb_oc, (long long)nb_ic, K, K,
            (long long)(nb_oc * nb_ic * K * K * 64));
        fwd_trace_ptr("wei(OIhw8i8o)", wei, 16);
    }

    const size_t src_need = (size_t)N * (size_t)nb_ic * (size_t)H * (size_t)W_in * 8u;
    float* __restrict src_b = acquire_fwd_oc_buf(tls_fwd_oc_src, tls_fwd_oc_src_cap, src_need);
    if (!src_b) return false;

    // NCHW -> nChw8c (logical W_in, not stride halo).
    #pragma omp parallel for collapse(3) schedule(static)
    for (int64_t n = 0; n < N; ++n) {
        for (int64_t ic_b = 0; ic_b < nb_ic; ++ic_b) {
            for (int64_t ih = 0; ih < H; ++ih) {
                for (int64_t iw = 0; iw < W_in; ++iw) {
                    float* d = &src_b[((((n * nb_ic + ic_b) * H + ih) * W_in + iw) * 8)];
                    for (int c = 0; c < 8; ++c) {
                        d[c] = x[(n * C_in + ic_b * 8 + c) * spatial_in
                            + ih * W_in_stride + iw];
                    }
                }
            }
    ...
    if (trace) {
        std::printf(
            "[FWD_TRACE] op2 reorder src: NCHW -> nChw8c = "
            "[N][nb_ic][H][Win][8]  floats=%zu\n",
            src_need);
        std::printf(
            "[FWD_TRACE]   nChw8c index=((n*nb_ic+ic_b)*H+ih)*Win*8 + iw*8 + c\n");
        fwd_trace_ptr("src_b(nChw8c)", src_b, 16);
    }

    const size_t dst_need = (size_t)N * (size_t)nb_oc * (size_t)out_h * (size_t)out_w * 8u;
    float* __restrict dst_b = acquire_fwd_oc_buf(tls_fwd_oc_dst, tls_fwd_oc_dst_cap, dst_need);
    if (!dst_b) return false;

    // Match jit_avx2_conv_kernel_f32 init_conf defaults for this geom.
    int ur_w = 3;
    if (out_w < ur_w) ur_w = (int)out_w;
    const int ur_w_tail = (int)(out_w % ur_w);
    const int nb_oc_blocking = (nb_oc >= 2) ? 2 : 1;
    const int64_t ocb_work = (nb_oc + nb_oc_blocking - 1) / nb_oc_blocking;
    const int64_t work_amount = N * ocb_work * out_h;

    if (trace) {
        int n_oi = (int)(out_w / ur_w);
        const int l_pad = (int)pad;
        const int r_pad = (int)((std::max)(
            (int64_t)0, (out_w - 1) - pad + K - W_in));
        int r_pad1 = (int)((std::max)(
            (int64_t)0, (ur_w * n_oi - 1) - pad + K - W_in));
        if (r_pad1 > 0) n_oi--;
        std::printf(
            "[FWD_TRACE] op3 compute plan: SIMD=OC8  ur_w=%d ur_w_tail=%d "
            "nb_oc_blocking=%d ocb_work=%lld work=N*ocb*oh=%lld\n",
            ur_w, ur_w_tail, nb_oc_blocking,
            (long long)ocb_work, (long long)work_amount);
        std::printf(
            "[FWD_TRACE]   dst during compute: nChw8c [N][nb_oc][oh][ow][8] floats=%zu\n",
            dst_need);
        std::printf("[FWD_TRACE]   OW schedule (solve_common):");
        int n_oi_sched = n_oi;
        int ow = 0;
        if (l_pad > 0) {
            n_oi_sched--;
            if (n_oi_sched < 0 && r_pad1 > 0) {
                std::printf(" lrpad(ow=%d,ur=%d,pl=%d,pr=%d)", ow, ur_w, l_pad, r_pad1);
            } else {
                std::printf(" lpad(ow=%d,ur=%d,pl=%d)", ow, ur_w, l_pad);
            }
            ow += ur_w;
        }
        for (int oi = 0; oi < (std::max)(n_oi_sched, 0); ++oi) {
            std::printf(" mid(ow=%d,ur=%d)", ow, ur_w);
            ow += ur_w;
        }
        if (r_pad1 > 0 && n_oi_sched >= 0) {
            std::printf(" rpad(ow=%d,ur=%d,pr=%d)", ow, ur_w, r_pad1);
            ow += ur_w;
        }
        if (ur_w_tail != 0) {
            std::printf(" tail(ow=%d,ur=%d,pr=%d)", ow, ur_w_tail, r_pad);
        }
        std::printf("\n");
        std::printf(
            "[FWD_TRACE]   inner tap: for ic_b,kh,kw,ifm2: vbroadcastss x[iw*8+ifm2]; "
            "vmovups W[8o]; vfmadd231 -> acc[oc_blk][ur]\n");
        std::printf(
            "[FWD_TRACE]   NOTE: this is C++ loops, not oneDNN jit:avx2 emit\n");
    }

    #pragma omp parallel for schedule(static)
    for (int64_t iwork = 0; iwork < work_amount; ++iwork) {
        int64_t t = iwork;
        const int64_t oh = t % out_h; t /= out_h;
        const int64_t ocbb = t % ocb_work; t /= ocb_work;
        const int64_t n = t;
        const int64_t oc0 = ocbb * nb_oc_blocking;
        const int oc_blocks = (int)std::min<int64_t>(nb_oc_blocking, nb_oc - oc0);

        auto width_blk_step = [&](int ow0, int ur, int /*pad_l*/, int /*pad_r*/) {
            __m256 acc[2][3];
            ...
            for (int64_t ic_b = 0; ic_b < nb_ic; ++ic_b) {
                for (int kh = 0; kh < K; ++kh) {
                    ...
                    if (ih < 0 || ih >= H) continue;
                    const float* __restrict src_row =
                        &src_b[((((n * nb_ic + ic_b) * H + ih) * W_in) * 8)];

                    for (int kw = 0; kw < K; ++kw) {
                        for (int ifm2 = 0; ifm2 < 8; ++ifm2) {
                            __m256 vx[3];
                            for (int jj = 0; jj < ur; ++jj) {
                                const int iw_abs = (int)(ow0 + jj - pad + kw);
                                if (iw_abs < 0 || iw_abs >= (int)W_in) {
                                    vx[jj] = _mm256_setzero_ps();
                                } else {
                                    vx[jj] = _mm256_set1_ps(src_row[iw_abs * 8 + ifm2]);
                                }
                            }
                            for (int ii = 0; ii < oc_blocks; ++ii) {
                                const float* __restrict wt =
                                    &wei[(((((oc0 + ii) * nb_ic + ic_b) * K + kh) * K + kw) * 64)
                                        + ifm2 * 8];
                                const __m256 wv = _mm256_loadu_ps(wt);
                                for (int jj = 0; jj < ur; ++jj) {
                                    acc[ii][jj] = _mm256_fmadd_ps(vx[jj], wv, acc[ii][jj]);
                                }
                            }
                        }
                    }
            ...
            for (int ii = 0; ii < oc_blocks; ++ii) {
                for (int jj = 0; jj < ur; ++jj) {
                    float* __restrict dp = &dst_b[((((n * nb_oc + (oc0 + ii)) * out_h + oh)
                        * out_w + (ow0 + jj)) * 8)];
                    _mm256_storeu_ps(dp, acc[ii][jj]);
                }
            }
        };

        // solve_common OW schedule (mirror jit_avx2_conv_fwd_kernel_f32)
        int n_oi = (int)(out_w / ur_w);
        const int l_pad = (int)pad;
        const int r_pad = (int)((std::max)(
            (int64_t)0, (out_w - 1) - pad + K - W_in));
        // end-pad after ur_w * n_oi outputs
        int r_pad1 = (int)((std::max)(
            (int64_t)0,
            (ur_w * n_oi - 1) - pad + K - W_in));
        if (r_pad1 > 0) n_oi--;
        ...
        if (l_pad > 0) {
            n_oi--;
            if (n_oi < 0 && r_pad1 > 0) {
                width_blk_step(ow, ur_w, l_pad, r_pad1);
            } else {
                width_blk_step(ow, ur_w, l_pad, 0);
            }
            ow += ur_w;
        }
        for (int oi = 0; oi < (std::max)(n_oi, 0); ++oi) {
            width_blk_step(ow, ur_w, 0, 0);
            ow += ur_w;
        }
        if (r_pad1 > 0 && n_oi >= 0) {
            width_blk_step(ow, ur_w, 0, r_pad1);
            ow += ur_w;
        }
        if (ur_w_tail != 0) {
            width_blk_step(ow, ur_w_tail, 0, r_pad);
        }
    }

    fwd_oc_reorder_nChw8c_to_nchw(
        dst_b, out, N, C_out, out_h, out_w, out_w_stride, bias, fuse_relu != 0);
    if (trace) {
        std::printf(
            "[FWD_TRACE] op4 reorder dst: nChw8c -> NCHW  "
            "out index=(n*Cout+c)*oh*out_w_stride + oh*out_w_stride + ow\n");
        fwd_trace_ptr("dst_b(nChw8c)", dst_b, 16);
        fwd_trace_ptr("out(NCHW)", out, 8);
        std::printf("[FWD_TRACE] === native OC-mimo EXIT ===\n");
        std::fflush(stdout);
    }
    return true;
}

static bool try_fwd_oc_simd(
    const float* x, const float* W, const float* bias, float* out,
    int64_t N, int64_t C_in, int64_t H, int64_t W_in, int64_t W_in_stride,
    int64_t C_out, int64_t k_h, int64_t k_w, int64_t pad, int64_t out_w_stride,
    int32_t fuse_relu
) {
    if (k_h != k_w || (C_out % 8) != 0 || (C_in % 8) != 0) return false;
    if (k_h < 1 || k_h > 11) return false;

    switch (k_h) {
        case 1: return conv2d_forward_oc_mimo_avx2<1>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 2: return conv2d_forward_oc_mimo_avx2<2>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 3: return conv2d_forward_oc_mimo_avx2<3>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 4: return conv2d_forward_oc_mimo_avx2<4>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 5: return conv2d_forward_oc_mimo_avx2<5>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 6: return conv2d_forward_oc_mimo_avx2<6>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 7: return conv2d_forward_oc_mimo_avx2<7>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 9: return conv2d_forward_oc_mimo_avx2<9>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
        case 11: return conv2d_forward_oc_mimo_avx2<11>(
            x, W, bias, out, N, C_in, H, W_in, W_in_stride, C_out, pad,
            out_w_stride, fuse_relu);
...
// ---------------------------------------------------------------------------
// Blocked FWD pipeline inspired by oneDNN layouts (contract path). Bwd stays NCHW.
// ---------------------------------------------------------------------------

static void fwd_maxpool_nChw8c_2x2(
    const float* __restrict src, float* __restrict dst, uint8_t* __restrict argmax,
    int64_t N, int64_t C, int64_t conv_h, int64_t conv_w,
    int64_t pool_h, int64_t pool_w
) {
    const int64_t nb = C / 8;
    #pragma omp parallel for collapse(3) schedule(static)
    for (int64_t n = 0; n < N; ++n) {
        for (int64_t b = 0; b < nb; ++b) {
            for (int64_t ph = 0; ph < pool_h; ++ph) {
                for (int64_t pw = 0; pw < pool_w; ++pw) {
                    const int64_t ih0 = ph * 2;
                    const int64_t iw0 = pw * 2;
                    const float* p00 = &src[((((n * nb + b) * conv_h + ih0) * conv_w + iw0) * 8)];
                    const float* p01 = p00 + 8;
                    const float* p10 = &src[((((n * nb + b) * conv_h + ih0 + 1) * conv_w + iw0) * 8)];
                    const float* p11 = p10 + 8;
                    float* d = &dst[((((n * nb + b) * pool_h + ph) * pool_w + pw) * 8)];
                    // argmax kept in NCHW channel order for existing pool bwd
                    for (int c = 0; c < 8; ++c) {
                        float v0 = p00[c], v1 = p01[c], v2 = p10[c], v3 = p11[c];
                        float mv = v0; uint8_t mi = 0;
                        if (v1 > mv) { mv = v1; mi = 1; }
                        if (v2 > mv) { mv = v2; mi = 2; }
                        if (v3 > mv) { mv = v3; mi = 3; }
                        d[c] = mv;
                        argmax[((n * C + b * 8 + c) * pool_h + ph) * pool_w + pw] = mi;
                    }
                }
            }
        }
...
void reorder_nChw8c_to_nchw_plane(
    const float* __restrict blocked, float* __restrict out,
    int64_t N, int64_t C, int64_t H, int64_t W, int64_t out_w_stride
) {
    const int64_t nb = C / 8;
    const int64_t spatial = H * out_w_stride;
    #pragma omp parallel for collapse(3) schedule(static)
    for (int64_t n = 0; n < N; ++n) {
        for (int64_t b = 0; b < nb; ++b) {
            for (int64_t h = 0; h < H; ++h) {
                for (int64_t w = 0; w < W; ++w) {
                    const float* s = &blocked[((((n * nb + b) * H + h) * W + w) * 8)];
                    for (int c = 0; c < 8; ++c) {
                        out[(n * C + b * 8 + c) * spatial + h * out_w_stride + w] = s[c];
                    }
                }
            }
        }
...
// In-place blocked -> NCHW using TLS temp (same float count when W_stride==W).
static void reorder_nChw8c_to_nchw_inplace(
    float* buf, int64_t N, int64_t C, int64_t H, int64_t W, int64_t out_w_stride
) {
    const size_t need = (size_t)N * (size_t)C * (size_t)H * (size_t)out_w_stride;
    float* tmp = acquire_fwd_oc_buf(tls_fwd_oc_dst, tls_fwd_oc_dst_cap, need);
    if (!tmp) return;
    // If stride>W, bias/zero halo not preserved — callers use logical W for blocked.
    reorder_nChw8c_to_nchw_plane(buf, tmp, N, C, H, W, out_w_stride);
    std::memcpy(buf, tmp, need * sizeof(float));
}

// Torch/oneDNN dataflow (from ONEDNN_VERBOSE on this geom):
//   L0: NCHW + Ohwi8o -> nChw8c; reorder -> NCHW; pool NCHW;
//       reorder pool -> nChw8c for L1
//   L1: nChw8c + OIhw8i8o -> nChw8c; reorder -> NCHW; pool NCHW (dense edge)
// Pad is in-kernel (edge/mid). No full blocked-act re-copy every call.

static void reorder_nchw_to_nChw8c_plane(
    const float* __restrict nchw, float* __restrict blocked,
    int64_t N, int64_t C, int64_t H, int64_t W, int64_t in_w_stride
) {
    const int64_t nb = C / 8;
    const int64_t spatial = H * in_w_stride;
    #pragma omp parallel for collapse(3) schedule(static)
    for (int64_t n = 0; n < N; ++n) {
        for (int64_t b = 0; b < nb; ++b) {
            for (int64_t h = 0; h < H; ++h) {
                for (int64_t w = 0; w < W; ++w) {
                    float* d = &blocked[((((n * nb + b) * H + h) * W + w) * 8)];
                    for (int c = 0; c < 8; ++c) {
                        d[c] = nchw[(n * C + b * 8 + c) * spatial
                            + h * in_w_stride + w];
                    }
                }
            }
...
static void reorder_nchw_to_nChw8c_inplace(
    float* buf, int64_t N, int64_t C, int64_t H, int64_t W, int64_t in_w_stride
) {
    const size_t need = (size_t)N * (size_t)C * (size_t)H * (size_t)W;
    float* tmp = acquire_fwd_oc_buf(tls_fwd_oc_dst, tls_fwd_oc_dst_cap, need);
    if (!tmp) return;
    reorder_nchw_to_nChw8c_plane(buf, tmp, N, C, H, W, in_w_stride);
    std::memcpy(buf, tmp, need * sizeof(float));
}

static void fwd_maxpool_nchw_2x2(
    const float* __restrict src, float* __restrict dst, uint8_t* __restrict argmax,
    int64_t N, int64_t C, int64_t conv_h, int64_t conv_w, int64_t conv_w_stride,
    int64_t pool_h, int64_t pool_w
) {
    ...
    for (int64_t n = 0; n < N; ++n) {
        for (int64_t c = 0; c < C; ++c) {
            const float* __restrict cp = &src[(n * C + c) * conv_spatial];
            float* __restrict pp = &dst[(n * C + c) * pool_spatial];
            uint8_t* __restrict ap = &argmax[(n * C + c) * pool_spatial];
            for (int64_t ph = 0; ph < pool_h; ++ph) {
                const float* r0 = cp + (ph * 2) * conv_w_stride;
                const float* r1 = r0 + conv_w_stride;
                for (int64_t pw = 0; pw < pool_w; ++pw) {
                    const int64_t iw = pw * 2;
                    float v0 = r0[iw], v1 = r0[iw + 1], v2 = r1[iw], v3 = r1[iw + 1];
                    float mv = v0; uint8_t mi = 0;
                    if (v1 > mv) { mv = v1; mi = 1; }
                    if (v2 > mv) { mv = v2; mi = 2; }
                    if (v3 > mv) { mv = v3; mi = 3; }
...
// Write nChw8c. NCHW src may use staged x_pad; blocked src uses in-kernel pad.
template <int K>
static bool conv2d_forward_to_nChw8c_avx2(
    const float* x, const float* W, const float* bias, float* out_blocked,
    int64_t N, int64_t C_in, int64_t H, int64_t W_in, int64_t W_in_stride,
    int64_t C_out, int64_t pad, int32_t src_nChw8c
) {
    const int64_t out_h = (H + 2 * pad - K) + 1;
    const int64_t out_w = (W_in + 2 * pad - K) + 1;
    if (out_h <= 0 || out_w <= 0) return false;
    const int64_t nb_oc = C_out / 8;
    const bool use_8i8o = (C_in % 8) == 0 && C_in >= 8;
    const int64_t nb_ic = use_8i8o ? (C_in / 8) : 0;
    if (src_nChw8c && !use_8i8o) return false;

    float* wei = fwd_oc_wei_get_or_pack(W, C_out, C_in, K, use_8i8o);
    if (!wei) return false;

    const int64_t mid_lo = std::min(pad, out_w);
    const int64_t mid_hi_raw = W_in - K + pad + 1;
    const int64_t mid_hi = std::min(out_w, std::max(mid_lo, mid_hi_raw));
    const int64_t oh_mid_lo = std::min(pad, out_h);
    const int64_t oh_mid_hi = std::min(out_h, std::max(oh_mid_lo, H - K + pad + 1));
    const __m256 v_zero = _mm256_setzero_ps();

    // Flat/NCHW: optional durable x_pad (same as specialists). Blocked: raw nChw8c.
    const float* x_compute = x;
    int64_t x_rs = W_in_stride;
    int64_t x_pl = 0;
    if (!src_nChw8c) {
        const int64_t x_pad_l = bwd_x_pad_l(pad);
        const int64_t x_row_stride = bwd_x_row_stride(K, pad, W_in, out_w);
        float* xp = staged_x_pad_lookup(
            x, N, C_in, H, W_in, W_in_stride, x_pad_l, x_row_stride);
        if (!xp) {
            const size_t need = (size_t)N * (size_t)C_in * (size_t)H * (size_t)x_row_stride;
            xp = acquire_bwd_x_pad_buf(need);
            if (!xp) return false;
            build_x_pad_buf(
                x, xp, N, C_in, H, W_in, W_in_stride, x_pad_l, x_row_stride);
        }
        x_compute = xp;
        x_rs = x_row_stride;
        x_pl = x_pad_l;
    }
    const int64_t spatial_pad = H * x_rs;

    auto store_blk = [&](int64_t n, int64_t oc_b, int64_t oh, int64_t ow, __m256 acc) {
        acc = _mm256_max_ps(acc, v_zero);
        _mm256_storeu_ps(
            &out_blocked[((((n * nb_oc + oc_b) * out_h + oh) * out_w + ow) * 8)],
            acc);
    };
    ...
    for (int64_t n = 0; n < N; ++n) {
        for (int64_t oc_b = 0; oc_b < nb_oc; ++oc_b) {
            for (int64_t oh = 0; oh < out_h; ++oh) {
                alignas(32) float bias_s[8];
                for (int c = 0; c < 8; ++c)
                    bias_s[c] = bias ? bias[oc_b * 8 + c] : 0.0f;
                const __m256 vb = _mm256_load_ps(bias_s);
                const bool oh_mid = (oh >= oh_mid_lo && oh < oh_mid_hi);

                auto accum_flat_pad = [&](int64_t ow, int ur) {
                    __m256 acc[3] = {vb, vb, vb};
                    const int64_t iw0 = x_pl + ow - pad;
                    for (int64_t kh = 0; kh < K; ++kh) {
                        const int64_t ih = oh - pad + kh;
                        if (ih < 0 || ih >= H) continue;
                        for (int64_t kw = 0; kw < K; ++kw) {
                            const float* w_kw =
                                &wei[((((oc_b * K + kh) * K + kw) * C_in) * 8)];
                            for (int64_t ic = 0; ic < C_in; ++ic) {
                                const float* x_row =
                                    x_compute + (n * C_in + ic) * spatial_pad
                                    + ih * x_rs + iw0;
                                const __m256 wv = _mm256_load_ps(w_kw + ic * 8);
                                for (int jj = 0; jj < ur; ++jj) {
                                    acc[jj] = _mm256_fmadd_ps(
                                        _mm256_set1_ps(x_row[kw + jj]), wv, acc[jj]);
                                }
                            }
                        }
                    }
                    for (int jj = 0; jj < ur; ++jj)
                        store_blk(n, oc_b, oh, ow + jj, acc[jj]);
                };

                auto edge_blk = [&](int64_t ow) {
                    __m256 acc = vb;
                    for (int64_t ic_b = 0; ic_b < nb_ic; ++ic_b) {
                        for (int64_t kh = 0; kh < K; ++kh) {
                            const int64_t ih = oh - pad + kh;
                            ...
                            for (int64_t kw = 0; kw < K; ++kw) {
                                ...
                                const float* w_tap =
                                    &wei[((((oc_b * nb_ic + ic_b) * K + kh) * K + kw) * 64)];
                                const float* xp = &x[(
                                    (((n * nb_ic + ic_b) * H + ih) * W_in + iw) * 8)];
                                for (int ic = 0; ic < 8; ++ic) {
                                    acc = _mm256_fmadd_ps(
                                        _mm256_set1_ps(xp[ic]),
                                        _mm256_load_ps(w_tap + ic * 8), acc);
                                }
                            }
                        }
                    }
                    store_blk(n, oc_b, oh, ow, acc);
                };
                auto mid_blk = [&](int64_t ow, int ur) {
                    __m256 acc[3] = {vb, vb, vb};
                    const int64_t iw0 = ow - pad;
                    for (int64_t ic_b = 0; ic_b < nb_ic; ++ic_b) {
                        for (int64_t kh = 0; kh < K; ++kh) {
                            const int64_t ih = oh - pad + kh;
                            if (!oh_mid && (ih < 0 || ih >= H)) continue;
                            if (ih < 0 || ih >= H) continue;
                            for (int64_t kw = 0; kw < K; ++kw) {
                                const float* w_tap =
                                    &wei[((((oc_b * nb_ic + ic_b) * K + kh) * K + kw) * 64)];
                                for (int ic = 0; ic < 8; ++ic) {
                                    const __m256 wv = _mm256_load_ps(w_tap + ic * 8);
                                    for (int jj = 0; jj < ur; ++jj) {
                                        const float* xp = &x[(
                                            (((n * nb_ic + ic_b) * H + ih) * W_in
                                             + (iw0 + kw + jj)) * 8)];
                                        acc[jj] = _mm256_fmadd_ps(
                                            _mm256_set1_ps(xp[ic]), wv, acc[jj]);
                                    }
                                }
                            }
                        }
                ...
                auto accum_8i8o_pad = [&](int64_t ow, int ur) {
                    __m256 acc[3] = {vb, vb, vb};
                    const int64_t iw0 = x_pl + ow - pad;
                    for (int64_t ic_b = 0; ic_b < nb_ic; ++ic_b) {
                        for (int64_t kh = 0; kh < K; ++kh) {
                ...
                int64_t ow = 0;
                if (src_nChw8c) {
                    for (; ow < mid_lo; ++ow) edge_blk(ow);
                    for (; ow + 2 < mid_hi; ow += 3) mid_blk(ow, 3);
                    for (; ow < mid_hi; ++ow) mid_blk(ow, 1);
                    for (; ow < out_w; ++ow) edge_blk(ow);
                } else if (use_8i8o) {
                    for (; ow + 2 < out_w; ow += 3) accum_8i8o_pad(ow, 3);
                    for (; ow < out_w; ++ow) accum_8i8o_pad(ow, 1);
                } else {
                    for (; ow + 2 < out_w; ow += 3) accum_flat_pad(ow, 3);
                    for (; ow < out_w; ++ow) accum_flat_pad(ow, 1);
                }
            }
        }
    }
...
static bool try_fwd_to_nChw8c(
    const float* x, const float* W, const float* bias, float* out_blocked,
    int64_t N, int64_t C_in, int64_t H, int64_t W_in, int64_t W_in_stride,
    int64_t C_out, int64_t k_h, int64_t k_w, int64_t pad, int32_t src_nChw8c
) {
    if (k_h != k_w || (C_out % 8) != 0 || C_out < 8) return false;
    if (k_h < 1 || k_h > 11) return false;
    switch (k_h) {
        case 1: return conv2d_forward_to_nChw8c_avx2<1>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 2: return conv2d_forward_to_nChw8c_avx2<2>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 3: return conv2d_forward_to_nChw8c_avx2<3>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 4: return conv2d_forward_to_nChw8c_avx2<4>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 5: return conv2d_forward_to_nChw8c_avx2<5>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 6: return conv2d_forward_to_nChw8c_avx2<6>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 7: return conv2d_forward_to_nChw8c_avx2<7>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 9: return conv2d_forward_to_nChw8c_avx2<9>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        case 11: return conv2d_forward_to_nChw8c_avx2<11>(x,W,bias,out_blocked,N,C_in,H,W_in,W_in_stride,C_out,pad,src_nChw8c);
        default: return false;
    }
}

static void fwd_relu_nChw8c_inplace(
    float* __restrict buf, int64_t N, int64_t C, int64_t H, int64_t W
) {
    const int64_t nfloat = N * C * H * W;
    const int64_t nvec = nfloat / 8;
    const __m256 v_zero = _mm256_setzero_ps();
    #pragma omp parallel for schedule(static)
    for (int64_t v = 0; v < nvec; ++v) {
        float* p = buf + v * 8;
        __m256 x = _mm256_loadu_ps(p);
        _mm256_storeu_ps(p, _mm256_max_ps(x, v_zero));
    }
    for (int64_t i = nvec * 8; i < nfloat; ++i) {
        buf[i] = std::max(buf[i], 0.0f);
    }
}

// Called from dispatcher block forward. Returns 1 if full block handled.
// Matches Torch Sequential+oneDNN verbose: conv(blocked dst) -> reorder NCHW
// -> pool NCHW -> (optional) reorder nChw8c for next conv.
extern "C" int32_t conv_block_forward_nChw8c_pipeline(
    ...
    // Gated: format-pipeline A/Bs lost vs specialists (infer ~4.8–6.8 ms vs
    // ~4.7 ms specialists; Torch ~2.8–3.2 ms). Not identical to oneDNN — sketch
    // only. Fall through until a measured win.
    (void)x; (void)W; (void)bias; (void)out_conv; (void)out_pool; (void)argmax;
    (void)N; (void)C_in; (void)H; (void)W_in; (void)W_in_stride; (void)C_out;
    (void)k_h; (void)k_w; (void)stride; (void)pad; (void)conv_out_w_stride;
    (void)pool_size; (void)pool_stride; (void)src_nChw8c; (void)keep_pool_nChw8c;
    if (out_conv_is_nChw8c) *out_conv_is_nChw8c = 0;
    if (out_pool_is_nChw8c) *out_pool_is_nChw8c = 0;
    return 0;

    if (stride != 1 || pool_size != 2 || pool_stride != 2) return 0;
    if ((C_out % 8) != 0) return 0;
    const int64_t out_h = (H + 2 * pad - k_h) + 1;
    const int64_t out_w = (W_in + 2 * pad - k_w) + 1;
    const int64_t pool_h = (out_h - 2) / 2 + 1;
    const int64_t pool_w = (out_w - 2) / 2 + 1;
    if (!try_fwd_to_nChw8c(
            x, W, bias, out_conv, N, C_in, H, W_in, W_in_stride,
            C_out, k_h, k_w, pad, src_nChw8c)) {
        return 0;
    }
    // ReLU already fused in stores. Torch: blocked dst -> NCHW before pool.
    reorder_nChw8c_to_nchw_inplace(
        out_conv, N, C_out, out_h, out_w, conv_out_w_stride);
    if (out_conv_is_nChw8c) *out_conv_is_nChw8c = 0;

    if (out_pool && argmax) {
        fwd_maxpool_nchw_2x2(
            out_conv, out_pool, argmax, N, C_out, out_h, out_w, conv_out_w_stride,
            pool_h, pool_w);
        if (keep_pool_nChw8c) {
            // Next conv wants aBcd8b (Torch reorder after pool).
            reorder_nchw_to_nChw8c_inplace(
                out_pool, N, C_out, pool_h, pool_w, pool_w);
            if (out_pool_is_nChw8c) *out_pool_is_nChw8c = 1;
        } else {
            if (out_pool_is_nChw8c) *out_pool_is_nChw8c = 0;
        }
    } else {
...
extern "C" void ensure_nchw_from_nChw8c(
    ...
    if (!buf || !is_nChw8c_flag || !*is_nChw8c_flag) return;
    reorder_nChw8c_to_nchw_inplace(buf, N, C, H, W, W_stride);
    *is_nChw8c_flag = 0;
}
...
void conv2d_forward_fallback_avx2(
    ...
    // Prefer libdnnl jit (inspired by Torch/mkldnn patterns, not a clone)
    {
        if (fwd_trace_enabled()) {
            std::printf("[FWD_TRACE] dispatch: try oneDNN\n");
            std::fflush(stdout);
        }
        if (conv2d_forward_onednn(
                x, W, bias, out,
                N, C_in, H, W_in, W_in_stride,
                C_out, k_h, k_w, stride, pad, out_w_stride, fuse_relu)) {
            return;
        }
    }

    // MIMO (ic%8==0): OC-8 + ur_w=3 path inspired by oneDNN. L0 (ic=3) stays OW specialists.
    if (stride == 1 && (C_in % 8) == 0 && (C_out % 8) == 0 && k_h == k_w
        && k_h >= 1 && k_h <= 11) {
        if (fwd_trace_enabled()) {
            std::printf(
                "[FWD_TRACE] dispatch: try OC-mimo (Cin%%8==0)\n");
            std::fflush(stdout);
        }
        if (try_fwd_oc_simd(
                x, W, bias, out,
                N, C_in, H, W_in, W_in_stride,
                C_out, k_h, k_w, pad, out_w_stride, fuse_relu)) {
            return;
        }
    }
