...
def run_pytorch_benchmark(
    ...
    """Configures PyTorch with 4 threads, executes training/inference, and tears down memory."""
    print("\n[1/2] Setting up and executing PyTorch benchmark run (4 Threads)...")
    
    # 1. Setup & Thread pool constraint
...
def run_custom_engine_benchmark(
    ...
    """Initializes Custom C++/NumPy ModelController, tracks kernel stats, and tears down."""
    print("[2/2] Setting up and executing Custom NumPy/AVX2 Engine benchmark run...")
...
def run_cnn_benchmark():
    ...
    print("PyTorch Thread Pool : 4 Threads (Restricted)")
    print("=" * 80)
    ...
    print("=" * 80)
    print(f"{'Performance Metric':<32} | {'PyTorch CNN (4T)':<20} | {'Custom NumPy CNN':<20}")
    print("-" * 80)
